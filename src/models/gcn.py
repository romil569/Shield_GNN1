"""Graph Convolutional Network baseline model for node classification."""
...
try:
    ...
    raise ImportError(
        "GCNModel requires torch-geometric. Install requirements-gnn.txt before training."
    ) from exc


class GCNModel(nn.Module):
    """A beginner-readable multi-layer GCN that returns class logits."""

    def __init__(self, in_channels, hidden_channels, out_channels, num_layers=2, dropout=0.5):
        """Initialize the GCN baseline."""
        super().__init__()
